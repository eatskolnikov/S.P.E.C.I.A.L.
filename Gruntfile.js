        ...
        copy: {
            main: {
                files: [
                    ...
                    {expand: true, flatten: true, src: ['src/perks.json'], dest: 'build/', filter:'isFile'},
                    {expand: true, flatten: true, src: ['src/assets/fonts/monofonto/*'], dest: 'build/assets/fonts', filter:'isFile'}
                ]
            }
        },
        clean:{
